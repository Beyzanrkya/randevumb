  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer} bounces={false}>
      ...
      <View style={styles.heroWrapper}>
        <ImageBackground 
          source={require('../assets/images/business_bg.png')} 
          style={styles.heroImage}
          imageStyle={{ borderRadius: 0 }}
        >
          <View style={styles.heroOverlay}>
            <View style={styles.heroCard}>
              <Text style={styles.heroCardTitle}>İşletmenizi{'\n'}Dijitalleştirin</Text>
              <Text style={styles.heroCardSubtitle}>
                Binlerce müşteriye ulaşın, randevularınızı akıllı takvimle yönetin ve işletmenizi büyütün.
              </Text>
            </View>
          </View>
        </ImageBackground>
      ...
      <View style={styles.formContainer}>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>İŞLETME GİRİŞİ</Text>
        </View>

        <Text style={styles.title}>Yönetim Paneli</Text>
        <Text style={styles.subtitle}>İşletme hesabınıza erişmek için bilgilerinizi girin.</Text>

        <View style={styles.form}>
          <View style={styles.inputGroup}>
            <Text style={styles.label}>İşletme E-postası</Text>
            <TextInput
              style={styles.input}
          ...
          >
            {loading ? (
              ...
              <Text style={styles.buttonText}>Panel'e Giriş Yap</Text>
            )}
          </TouchableOpacity>
